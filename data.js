var initData = {
    ...
    statistics: [    // 柱状图数据
        {
            ...
            data: [{
                ...
                CPI: '系列5',
                instance: '新版网站测试服务器2_内存_内存总量MB_系列4',
                kpi: '新版网站测试服务器2_内存_内存总量MB_系列5',
                numberValue: 340
            },{
                CPI: '系列6',
                instance: '新版网站测试服务器2_内存_内存总量MB_系列4',
                kpi: '新版网站测试服务器2_内存_内存总量MB_系列6',
                numberValue: 360
            },{
                CPI: '系列7',
                instance: '新版网站测试服务器2_内存_内存总量MB_系列4',
                kpi: '新版网站测试服务器2_内存_内存总量MB_系列7',
                numberValue: 200
            },{
                CPI: '系列8',
                instance: '新版网站测试服务器2_内存_内存总量MB_系列4',
                kpi: '新版网站测试服务器2_内存_内存总量MB_系列8',
                numberValue: 170
            },{
                CPI: '内存总量MB_系列9',
                instance: '新版网站测试服务器2_内存_内存总量MB_系列4',
                kpi: '新版网站测试服务器2_内存_内存总量MB_系列9',
                numberValue: 100
            },{
                CPI: '内存总量MB_系列9',
                instance: '新版网站测试服务器2_内存_内存总量MB_系列4',
    ...
    // legendData: ['系列1', '内存总量_系列2', '系列3', '系列4', '系列5', '系列6', '系列7', '系列8', 'lala 9', '10'],
    legendData: ['新版网站测试服务器2_内存_内存总量MB_系列1','新版网站测试服务器2_内存_内存总量MB_系列2','新版网站测试服务器2_内存_内存总量MB_系列3','新版网站测试服务器2_内存_内存总量MB_系列4'],  // 图例内容
    legendColor: ['#ff0', '#f00', '#f0f', '#0f0', '#0ff', '#f0d', '#dad', '#2f2', '#6a6'], // 图例颜色，对应柱状图颜色
    legendType: 'kpi',  
